package com.ksquarej.online_class_proj.Teachers;
...
public class TeacherHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView = findViewById(R.id.nav_view_teach);

        mToggle=new ActionBarDrawerToggle(this,drawer,R.string.open,R.string.close);
        Bundle extras = getIntent().getExtras();
        org_id=extras.getString("org_id");
        teach_id=extras.getString("teach_id");
        ...
        tx.replace(R.id.nav_host_fragment, new Classes_teachers(org_id,teach_id));
        tx.commit();
    }
    ...
    protected void onStart() {
        ...
        try {
            GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(TeacherHome.this);
            if (acct != null) {
...
//                mref.child("Profiles").child(acct.getId()).setValue(profileClass);
    ...
    public void checkPermission(String permission, int requestCode)
    {
        ...
        if (PackageManager.PERMISSION_GRANTED != ContextCompat.checkSelfPermission(
                ...
                permission)) {
            ActivityCompat.requestPermissions(TeacherHome.this,
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_teachers_courses:
                navigationView.getMenu().getItem(1).setChecked(false);
                navigationView.getMenu().getItem(0).setChecked(false);
                navigationView.getMenu().getItem(2).setChecked(true);
                fragment = new Classes_teachers(org_id,teach_id);
                break;
    ...
    private void showLogoutDialog()
    {
        ...
        builder.setPositiveButton("LOGOUT", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(TeacherHome.this, "Successfully signed out", Toast.LENGTH_SHORT).show();
