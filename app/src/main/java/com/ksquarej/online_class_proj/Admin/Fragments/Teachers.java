        ...
        FirebaseDatabase.getInstance().getReference().child("organisation").child(org_id).child("teachers").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot ds:dataSnapshot.getChildren()){
                    teacher_lst.add(new add_class(ds.child("email").getValue().toString()));
                }
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!email_teacher.getText().toString().equals("")) {
                        ...
                        m_ref.child("organisation").child(org_id).child("teachers").push().setValue(new add_class(email_teacher.getText().toString()));
                        customView.dismiss();
                    }
                }
            });
